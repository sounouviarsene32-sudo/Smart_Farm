...
<template>
  <div
    class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex flex-col justify-between transition-hover hover:shadow-lg"
  >
    <div class="flex justify-between items-start gap-4 mb-5">
      ...
      <span
        :class="[
          ...
          getPerformanceClass(chef.performance),
        ]"
      >
    ...
    <div class="grid grid-cols-2 gap-4 text-center mb-6">
      <div class="border-r border-slate-100 pr-4">
        ...
        <p class="text-3xl font-bold text-slate-900">{{ chef.dept?.agentsCount || 0 }}</p>
      </div>
      <div class="flex flex-col items-center">
        ...
        <p class="text-3xl font-bold text-slate-900">{{ chef.dept?.animalsCount || 0 }}</p>
