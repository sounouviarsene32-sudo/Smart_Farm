...
<template>
    ...
    <main class="flex-1 lg:ml-64 p-4 lg:p-8 transition-all duration-300 w-full bg-red-50 min-h-screen space-y-8">
      <header class="flex justify-between items-start mb-8">
        <div>
          <h2 class="text-2xl font-bold text-slate-800">Dashboard Chef département (Bovin)</h2>
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-8">
        <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm h-[400px]">
          <h3 class="font-bold text-slate-800 mb-6">Revenu du Département</h3>
          <div class="h-[300px]">
        ...
        >
          <h3 class="font-bold text-slate-800 mb-6">Estimation des Dépenses du Département</h3>
      ...
      <div class="grid grid-cols-1 gap-6">
        <!-- <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm"> -->
          ...
          > -->
            <!-- <h3 class="font-bold text-slate-800">Total Agents</h3>
            <span class="text-xl font-bold text-emerald-600">12,500</span> -->
          <!-- </div> -->
          <!-- <div class="space-y-4">
            <div
